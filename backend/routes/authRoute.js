...
router.post("/forgotPassword", async (req, res) => {
  ...
  const mailOptions = {
    ...
    html: `Вы получили это письмо, потому что вы (или кто-то другой) запросили сброс пароля для вашей учетной записи.<br><br>
           Пожалуйста, <a href="http://localhost:3000/reset/${token}">перейдите по следующей ссылке</a>, или вставьте ее в адресную строку вашего браузера, чтобы завершить процесс:<br><br>
